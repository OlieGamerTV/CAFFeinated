...
| Viva Pinata | Supports the *.bnl files contained in <b>bundles/</b>, the various *.pkg files as well as some support for the debug package in <b>debug/</b> |
| Viva Pinata: Trouble in Paradise | Pretty much the same thing as the first game. *.bnl's, *.pkg's and the debug package in <b>packed/</b> |
...
| Kinect Sports | Supports the uncompressed V40 bundle files. |
...
| ------------- | ------------- |
| R1 Bundle File  | This is the most common format found, defined by its magic of "CAFF".<br/>The currently supported versions are V0026, V0031, V0036 and V0040.  |
...
| ------------- | ------------- |
| Loctext Editor  | A viewer for the localisation text banks (often abbreviated to just loctext) used in various R1 titles.<br/>Supports both <b>LSBL</b>/<b>LBSL</b> and <b>LSB2</b>/<b>LBS2</b> |
